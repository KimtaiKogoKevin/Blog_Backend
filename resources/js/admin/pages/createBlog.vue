			...
			<div class="container-fluid">
				...
				<div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
					...
					<div class="_input_field">
						 <Input type="text" v-model="data.title"  value="data.title" placeholder="Title" />
					 </div>
					...
					<div class="_input_field">
						 <Input  type="textarea" v-model="data.post_excerpt" :rows="4"  value="data.post_excerpt" placeholder="Post excerpt " />
					 </div>
					<div class="_input_field">
                    ...
                    <div class="_input_field">
						 <Input  type="textarea" v-model="data.metaDescription" value="data.metaDescription" :rows="4" placeholder="Meta description" />
					 </div>
